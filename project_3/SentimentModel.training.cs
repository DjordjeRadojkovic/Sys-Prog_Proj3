...
namespace Project_3
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Carthamus85\Downloads\sentiment labelled sentences\sentiment labelled sentences\imdb_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastForest(new FastForestBinaryTrainer.Options(){NumberOfTrees=22,NumberOfLeaves=11,FeatureFraction=1F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}),labelColumnName:@"col1"))      
